...
const DynamicMeta = () => {
  ...
  useEffect(() => {
    ...
    if (pathname === "/about") {
      ...
      keywords = "Elanchezhiyan P, Senior .NET Developer, Azure Expert, Cloud Architect, DevOps Engineer, Full Stack Developer, Software Consultant, Tech Mentor";
    }
    ...
    setPropertyTag("og:image:alt", "Elanchezhiyan P - Senior .NET & Azure Developer");
    ...
    setMetaTag("twitter:image:alt", "Elanchezhiyan P - Senior .NET & Azure Developer");
...
const addStructuredData = (pathname: string, yearsOfExperience: number) => {
  ...
  if (pathname === "/projects") {
    ...
    structuredData.description = "Blog articles about .NET, Azure, and software development";
  } else if (pathname === "/contact") {
    structuredData["@type"] = "ContactPage";
    structuredData.name = "Contact";
    structuredData.description = "Contact Elanchezhiyan P for software development services";
  } else if (pathname === "/book") {
    structuredData["@type"] = "Service";
    structuredData.name = "Consultation Services";
    structuredData.description = "Book consultation and mentorship services with Elanchezhiyan P";
