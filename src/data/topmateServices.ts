...
export const topmateServices: TopmateService[] = [
  {
    ...
    title: "Quick Chat",
    description:
      "Have a brief discussion about what I do, how I can help you, or ask any short query about interview prep or tech advice.",
    type: "Video Meeting",
    duration: "10 min",
    price: 180,
    discountPrice: 100,
  ...
  },
  {
    ...
    description:
      "Explore how I can help with your tech goals or project.",
    type: "Video Meeting",
    duration: "15 min",
    price: 0,
    badge: "Popular",
  ...
  },
  {
    ...
    description:
      "Get expert feedback on your resume and portfolio to make a lasting impression.",
    type: "Video Meeting",
    duration: "30 min",
    price: 200,
    discountPrice: 150,
  ...
  },
  {
    ...
    description:
      "Tailored mentoring in .NET, React & DevOps.",
    type: "Video Meeting",
    duration: "30 min",
    price: 500,
    discountPrice: 300,
  ...
  },
  {
    ...
    description:
      "Make your LinkedIn stand out professionally.",
  ...
  },
  {
    ...
    description:
      "Get an ATS-optimized resume that lands interviews.",
    type: "Digital Product",
    price: 100,
    discountPrice: 50,
  ...
  },
  {
    ...
    description:
      "Expert .NET & React help – fast, reliable, priority.",
    type: "Priority DM",
    duration: "Replies in a day",
    price: 50,
    badge: "Popular",
  ...
  },
  {
    ...
    description:
      "Mentorship, resume review & clarity call—everything to grow.",
    type: "Package",
    packageDetails: [
